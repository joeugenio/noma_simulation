...
# simul_case02 = np.load(const.OUT_PATH+'simul_case_2_users.npy')
# simul_case04 = np.load(const.OUT_PATH+'simul_case_4_users.npy')
# simul_case06 = np.load(const.OUT_PATH+'simul_case_6_users.npy')
...
# label = ['Exhaustive', 'Fair', 'Random', 'PA fix', 'OMA']
# plt.plot_cdf(c, sh=True, filename='cdf_6_user', lab=label)
...
# label = ['Exhaustive', 'Fair', 'Random', 'PA fix', 'OMA']
# plt.plot_cdf(c, sh=True, filename='cdf_4_user', lab=label)
...
# label = ['Exhaustive', 'Fair', 'Random', 'PA fix', 'OMA']
# plt.plot_cdf(c, sh=True, filename='cdf_2_user', lab=label)
