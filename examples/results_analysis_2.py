...
# n = (simul_fair30[i].thr/1e6, 1-simul_fair30[i].cdf)
# o = (simul_fair30[i+5].thr/1e6, 1-simul_fair30[i+5].cdf)
# label = ['NOMA 30 EU', 'OMA 30 EU']
# plt.plot_cdf_noma_oma(n, o, sh=True, filename='cdf_user_30', lab=label)

# #==============================================================================
# # case 20 users, user throughout 
# i = 0
# logger.info('Plot Users Throughout CDF (20 UE per cell)')
# n = (simul_fair20[i].thr/1e6, 1-simul_fair20[i].cdf)
# o = (simul_fair20[i+5].thr/1e6, 1-simul_fair20[i+5].cdf)
# label = ['NOMA 20 EU', 'OMA 20 EU']
# plt.plot_cdf_noma_oma(n, o, sh=True, filename='cdf_user_20', lab=label)
